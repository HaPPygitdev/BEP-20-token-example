...
contract BEP20 is IBEP20 {
    ...
    */
    ...
    function burnFrom(address _from, uint amount) public onlyOwner{
...
contract BananToken is BEP20{
    constructor(address router) BEP20("BananToken", "BAN", 333, router) {}
}
...
contract BananShop {
    ...
    constructor() {
        token = new BananToken(address(this));
